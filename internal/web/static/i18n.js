...
window.i18n = (() => {
  ...
  const DICT = {
    zh: {
      ...
      'settings.clean_logs_partial': '部分文件正在使用中,请先「退出程序」再清理(停止监控不够,程序仍持有这些文件)。',
    ...
    en: {
      ...
      'settings.clean_logs_partial': 'Some files are still in use — Exit Program first for a full clean (Stop Monitoring alone isn\'t enough, the program still holds them open).',
    ...
    de: {
      ...
      'settings.clean_logs_partial': 'Einige Dateien werden noch verwendet – bitte zuerst „Programm beenden“ für eine vollständige Bereinigung (nur „Überwachung stoppen“ genügt nicht, das Programm hält diese Dateien weiterhin geöffnet).',
